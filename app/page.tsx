...
export default function Home() {
  ...
  return <main>
    ...
    <section className="visit" id="visitanos"><div className="visit-copy"><p className="eyebrow">TE ESPERAMOS</p><h2>Tu próxima<br/><em>parada.</em></h2><p className="pending">Completa la dirección y el horario antes de publicar.</p><div className="details"><div><Icon name="pin"/><span>La Monacilla<br/><small>Huelva, España</small></span></div><div><Icon name="clock"/><span>Abierto desde las 8:00<br/><small>Consulta el horario del día</small></span></div></div><div className="actions"><a className="button darkbutton" href="#contacto">Contactar <Icon name="arrow" /></a><a className="textlink dark" href="https://www.instagram.com/canelaymiel.lamonacilla/" target="_blank" rel="noreferrer">Instagram <Icon name="instagram" /></a></div></div><div className="map-placeholder" aria-label="Mapa de La Monacilla"><div><Icon name="pin"/><span>LA MONACILLA</span><small>Mapa disponible al confirmar la dirección</small></div></div></section>
