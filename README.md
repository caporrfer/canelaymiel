...
- Los datos del negocio, la carta y las reseñas están en `src/data/site.ts`.
...
- El menú semanal queda fuera de esta versión hasta disponer de una fotografía oficial apropiada; se puede reintroducir junto con ese material.
